...
public class ProjectionSelectionPanel extends javax.swing.JPanel {
    ...
    /**
     * The lines that are displayed. Must be in geographic coordinates (degrees).
     */
     ...
     * @param lines The lines to project. Must be in geographic coordinates (degrees).
     */
    ...
    /**
     * Write basic infromation about the projection to the graphical user interface.
